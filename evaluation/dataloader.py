...
class IGB260M(object):
    ...
    def paper_feat(self) -> np.ndarray:
        ...
        if self.data == 'OGB':
            # path = osp.join(self.dir, '/raw/node_feat.npy')
            path = '/data/OGB/ogbn_papers100M/raw/node_feat.npy'
            if self.in_memory:
                emb = np.load(path)
            else:
            ...
            path = '/data/igb/full/processed/paper/node_feat.npy'
    ...
    def paper_label(self) -> np.ndarray:
        if(self.data == 'OGB'):
            ...
            path = '/data/OGB/ogbn_papers100M/raw/node_label.npy'
            ...
            if self.num_classes == 19:
                # path = '/data/igb/full/processed/paper/node_label_19_extended.npy'
                path = '/data/igb/full/processed/paper/node_label_19.npy'
                if(self.in_memory):
                ...
                path = '/data/igb/full/processed/paper/node_label_2K_extended.npy'
    ...
    def paper_edge(self) -> np.ndarray:
        ...
        if self.data == 'OGB':
            ...
            path = '/data/OGB/ogbn_papers100M/raw/edge_index.npy'
        elif self.size == 'full':
            path = '/data/igb/full/processed/paper__cites__paper/edge_index.npy'
        elif self.size == 'large':
            path = '/mnt/nvme7/large/processed/paper__cites__paper/edge_index.npy'
        elif self.size == 'medium':
            path = '/data/igb/medium/processed/paper__cites__paper/edge_index.npy'
        elif self.size == 'small':
            path = '/data/igb/small/processed/paper__cites__paper/edge_index.npy'
...
class IGB260MDGLDataset(DGLDataset):
    ...
    def process(self):
        ...
        if self.args.dataset_size == 'full':
            ...
            print(f'size:{self.args.dataset_size}')
            n_nodes = node_features.shape[0]
...
class OGBDGLDataset(DGLDataset):
    ...
    def process(self):
        ...
        split_path = osp.join(self.dir,'../ogbn_papers100M/split', 'time')
