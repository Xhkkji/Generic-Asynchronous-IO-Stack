...
sudo env \
  ...
  GIDS_REGISTERED_ENABLE_SKIP_FRONT="${GIDS_REGISTERED_ENABLE_SKIP_FRONT:-1}" \
  GIDS_REGISTERED_SUBMIT_COMMANDS_PER_BATCH="${GIDS_REGISTERED_SUBMIT_COMMANDS_PER_BATCH:-2}" \
